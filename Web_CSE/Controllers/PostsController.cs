...
namespace Web_CSE.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,Describe,Date,Author,AccountId,CatId,Thumb")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Title,Describe,Date,Author,AccountId,CatId,Thumb")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
